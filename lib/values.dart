...
class Byte extends NumberValue {
  ...
  Byte(int num,{ErrorGenerator error_generator}) {set(num);super._gen = error_generator;}

  /// Used to insert a boolean into nbt data
  Byte.Boolean(bool b,{ErrorGenerator error_generator}) {set(b);super._gen = error_generator;}
...
class Short extends NumberValue {
  ...
  Short(int num,{ErrorGenerator error_generator}) {set(num);super._gen = error_generator;}
...
class Integer extends NumberValue {
  ...
  Integer(int num,{ErrorGenerator error_generator}) {set(num);super._gen = error_generator;}

  /// the integer value (number from -2147483648 to 2147483647)
  void set(int v) {
    if(v > 2147483647 || v < -2147483648) throw this._gen.error("Byte must be between -2147483648 and 2147483647");
    this._number = v;
  }
...
class Long extends NumberValue {
  ...
  Long(int num,{ErrorGenerator error_generator}) {set(num);super._gen = error_generator;}
...
class Float extends NumberValue {
  ...
  Float(double num,{ErrorGenerator error_generator}) {set(num);super._gen = error_generator;}
...
class Double extends NumberValue {
  ...
  /// Used to insert a float into nbt data
  Double(double num,{ErrorGenerator error_generator}) {set(num);super._gen = error_generator;}
